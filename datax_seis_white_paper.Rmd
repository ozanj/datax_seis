...
Here is an example of linking to [Appendix A](#curriculum).
...
Data Science for Everyone. An absolute zero entry course – no pre-reqs. Aimed at getting basic data science concepts out into the general student population beyond Data Science majors. It is a more accessible version of the [Berkeley Data 8](http://data8.org/) class with policy and critical concepts.  Perhaps a year-long sequence of courses, divided along GE components?

Data Studies Ethics & Policy (fulfills Society and Culture breadth requirement and undergraduate writing requirement) Aimed at Data Science majors, but anyone can take. No pre-reqs.
...
- POI or C2I2 or DH
- CRESST: Evaluation, assessment and measurement, particularly in the areas of psychometrics and education.
